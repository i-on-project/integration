...
internal class MappingTaskletTest {
    ...
    private val imNotSureYet = "???"
    private val rawData = RawTimetableData(jsonData, textData, imNotSureYet)
    ...
    private fun assertions(timetableTeacher: TimetableTeachers) {
        ...
        assertEquals("Teresa Maria de Araújo Melo Quinteiro", timetableTeacher.teachers[0].courses[0].instructors[0].name)

        assertEquals("GAP", timetableTeacher.teachers[0].courses[1].classDetail.acronym)
        assertEquals(1, timetableTeacher.teachers[0].courses[1].instructors.count())
        assertEquals("Cristina Inês Camus", timetableTeacher.teachers[0].courses[1].instructors[0].name)

        assertEquals("E", timetableTeacher.teachers[0].courses[2].classDetail.acronym)
        assertEquals(2, timetableTeacher.teachers[0].courses[2].instructors.count())
        assertEquals("Fernando dos Santos Azevedo", timetableTeacher.teachers[0].courses[2].instructors[0].name)
        assertEquals("João Manuel Ferreira Martins", timetableTeacher.teachers[0].courses[2].instructors[1].name)
    }
}
